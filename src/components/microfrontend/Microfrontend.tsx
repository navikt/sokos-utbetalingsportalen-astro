...
import {checkRouteAccess, useAuthContext} from "../../utils/client/userAuth.ts";
...
// TODO: find location  const location = useLocation();
  ...
  const MicrofrontendBundle = createMicrofrontendBundle("http://localhost:3000/attestasjon/bundle.js");
